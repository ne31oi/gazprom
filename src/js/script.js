...
var scene = new ScrollMagic.Scene({ triggerElement: "header", duration: $("header").outerHeight() * 1.5 })
    ...
    .on("progress", function(e) {
        ...
        if (mesh) {
            ...
            head_text.style.zIndex = (e.progress > 0.55) ? 2 : 3;
...
var scene = new ScrollMagic.Scene({ triggerElement: ".years", duration: $(".years").outerHeight() })
    ...
    .on("progress", function(e) {
        $(".data-item").each(function() {
            ...
            /*if ($(this).hasClass("data-item1") || $(this).hasClass("data-item2") || $(this).hasClass("data-item3")) {
                if (n > no) {
            ...
            console.log(n)*/
            //$(this).text(n > parseInt($(this).attr("data-num-old"))) ? (parseInt($(this).attr("data-num-old"): n) + "%");
        });
...
function init() {
    ...
    scene.fog = new THREE.Fog(0x01012f, 10, 100);
